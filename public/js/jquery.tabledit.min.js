...
!(function (t) {
    ...
    t.fn.Tabledit = function (e) {
            ...
            var l = t.post(
                ...
                function (t, n, a) {
                    e === d.buttons.edit.action &&
                        ...
                        setTimeout(function () {
                            i.find("tr." + d.warningClass).removeClass(
                                d.warningClass
                            );
                        }, 1400)),
                        d.onSuccess(t, n, a);
            ...
            return (
                l.fail(function (t, n, i) {
                    e === d.buttons["delete"].action
                        ? (o.removeClass(d.mutedClass).addClass(d.dangerClass),
                          o
                              .find(".tabledit-toolbar button")
                              .attr("disabled", !1),
                          o
                              .find(
                                  ".tabledit-toolbar .tabledit-restore-button"
                              )
                              .hide())
                        : e === d.buttons.edit.action &&
                          s.addClass(d.dangerClass),
                        d.onFail(t, n, i);
                }),
                l.always(function () {
                    d.onAlways();
        ...
        var i = this,
                    ...
                    identifier: function () {
                        d.hideIdentifier &&
                            i
                                .find(
                                    "th:nth-child(" +
                                        parseInt(d.columns.identifier[0]) +
                                        "1), tbody td:nth-child(" +
                                        parseInt(d.columns.identifier[0]) +
                                        "1)"
                                )
                                .hide();
                        var e = i.find(
                            "tbody td:nth-child(" +
                                (parseInt(d.columns.identifier[0]) + 1) +
                                ")"
                        );
                        e.each(function () {
                            var e =
                            ...
                            t(this).html(e + n),
                                t(this)
                                    .parent("tr")
                                    .attr(d.rowIdentifier, t(this).text());
                        });
                    },
                    editable: function () {
                        for (var e = 0; e < d.columns.editable.length; e++) {
                            var n = i.find(
                                "tbody td:nth-child(" +
                                    (parseInt(d.columns.editable[e][0]) + 1) +
                                    ")"
                            );
                            n.each(function () {
                                var n = t(this).text();
                                ...
                                if (
                                    "undefined" !=
                                    typeof d.columns.editable[e][2]
                                ) {
                                    var a =
                                        '<select class="tabledit-input ' +
                                        d.inputClass +
                                        '" name="' +
                                        d.columns.editable[e][1] +
                                        '" style="display: none;" disabled>';
                                    t.each(
                                        jQuery.parseJSON(
                                            d.columns.editable[e][2]
                                        ),
                                        function (t, e) {
                                            a +=
                                                n === e
                                ...
                                t(this).html(i + a),
                                    t(this).addClass("tabledit-view-mode");
                            });
                        }
                    },
                    toolbar: function () {
                        if (d.editButton || d.deleteButton) {
                            var t = "",
                                ...
                                a = "",
                                s = "";
                            0 === i.find("th.tabledit-toolbar-column").length &&
                                i
                                    .find("tr:first")
                                    .append(
                                ...
                                d.deleteButton &&
                                    ...
                                    (a =
                                        ...
                                        d.buttons.restore["class"] +
                                        '" style="display: none; float: none;">' +
                                        d.buttons.restore.html +
                                        "</button>");
                            var o =
            ...
            u = {
                view: function (e) {
                    ...
                    t(e)
                        ...
                        d.editButton &&
                            (n.find("button.tabledit-save-button").hide(),
                            n
                                .find("button.tabledit-edit-button")
                                .removeClass("active")
                                .blur());
                },
                edit: function (e) {
                    ...
                    i.prop("disabled", !1).show(),
                        ...
                        d.editButton &&
                            (n
                                .find("button.tabledit-edit-button")
                                .addClass("active"),
                            n.find("button.tabledit-save-button").show());
                },
            },
            b = {
                reset: function (e) {
            ...
            c = {
                reset: function (t) {
                    i.find(".tabledit-confirm-button").hide(),
                        i
                ...
                restore: function (e) {
                    ...
                    t(e)
                        ...
                        i !== !1 &&
                            (t(e)
                                .parent("tr")
                                .removeClass("tabledit-deleted-row"),
                            t(e)
                                .parent("tr")
                                .removeClass(d.mutedClass)
                                .find(".tabledit-toolbar button")
                                .attr("disabled", !1),
        ...
        return (
                ...
                : (i.on(
                  ...
                  t(document).on("click", function (t) {
                      ...
                      e.is(t.target) ||
                          ...
                          b.reset(
                              i.find(".tabledit-input:visible").parent("td")
                          );
                  })),
            t(document).on("keyup", function (t) {
                ...
                switch (t.keyCode) {
                    case 9:
                        d.editButton ||
                            (b.submit(a), u.edit(a.closest("td").next()));
                        break;
                    case 13:
                        b.submit(a);
                        break;
