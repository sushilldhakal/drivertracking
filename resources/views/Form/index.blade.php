                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-7">
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="type" @checked(old('type')=='arrived' ) id="inlineRadio3" required value="arrived">
                            <label class="form-check-label" for="inlineRadio3">Arived</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="type" @checked(old('type')=='depart' ) id="inlineRadio4" required value="depart">
