                        ...
                        <div class="main-card mb-3 card">
                            <div class="card-body">
                                ...
                                <div class="card-content">
                                    <table id="dynamic-table-1" class="table" data-id-field="code"
                                        data-sort-name="value1" data-sort-order="desc" data-show-chart="false"
                ...
                <div class="modal-content">
                    <form class="form w-100">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label>Address</label>
                                <input type="text" class="form-control" placeholder="Driver's address" required="">
                            </div>

                            <div class="form-group">
                                <label>Contact Details</label>
                                <input type="text" class="form-control" placeholder="Driver's contact details"
                                    required="">
                            </div>
